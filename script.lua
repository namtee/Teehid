...
local autoFarm = false         -- Auto Farm LV
local safeMode = false         -- ถ้าเปิด จะ Anchored ตัวเราขณะตีมอน เพื่อไม่ให้โดนตี
local mobGather = false        -- (Placeholder) ถ้าเปิด จะ Anchored มอนให้อยู่รวมกัน
local autoStats = false        -- ลงแต้มอัตโนมัติ
local autoBossFarm = false     -- ตีบอสอัตโนมัติ
local autoCDK = false          -- ฟาร์ม CDK
local autoSoulGuitar = false   -- ฟาร์ม Soul Guitar
local autoSharkAnchor = false  -- ฟาร์ม Shark Anchor
local fastMode = false         -- เน้นปั๊มเลเวลจนถึง 2600
local autoRaces = false        -- ทำเผ่า v1-v3
local autoStyles = false       -- ทำหมัดพิเศษ
local autoFruitsSystem = false -- Fruits System
local lockFragments = false
local lockFruitsRaid = false
local autoFarmMastery = false
local masteryMelee = false
local masterySword = false
local masteryFruit = false
local autoBuyStyles = false
local autoRaid = false
local autoSeaEvent = false
local autoWebhook = false
local autoSecretQuest = false
local autoServerHop = false
local autoSaveConfig = false
local antiLagExtreme = false
local uiAnimation = false
