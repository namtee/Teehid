...
--[[
    ...
    + รวมกับ Code “All Automatic + Hide UI Toggle” 
    + Code Phase 1-10 (เก่า & ใหม่)
    + _G.Team = "Pirates" / "Marines"
    + Safe Fly V2, Fast Attack, Anti-AFK, Anti-Lag ฯลฯ

    **หมายเหตุ**: โค้ดอาจซ้ำซ้อน เนื่องจากเรา “ไม่ตัดอะไรออก” 
    ใช้เพื่ออ้างอิงหรือปรับแก้ตามต้องการ
]]
--------------------------------------------------------------------------------
...
spawn(function()
    ...
    wait(2)
    startAutoFarm() -- เรียกฟังก์ชันฟาร์มหลังเลือกทีม
end)
...
print("[TeeHid Hub] พร้อมฟาร์ม Auto Quest + Safe Mode + Team Selector + Activate Tool")
